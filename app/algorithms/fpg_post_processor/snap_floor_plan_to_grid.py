...
def plot_post_process(original: Sequence[ProcessedRoomData], snapped: Sequence[ProcessedRoomData]):
    """
...
def snap_floor_plan_to_grid(processed_floor_plan: list[ProcessedRoomData]) -> list[ProcessedRoomData]:
    ...
    print(f"Snapped Plan: {snapped_plan}\n")
